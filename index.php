...
// Fetch all portfolio data using the global function
$portfolioData = fetchPortfolioData($conn);

// Extract data into individual variables for backward compatibility
$isLoggedIn = $portfolioData['isLoggedIn'];
            ...
            <?php else: ?>
                  ...
                  <div class="cv-content slide-in-left">
                        <div class="card-body">
                              ...
                              <div id="personal-info" class="cv-section">
                              ...
                              <!-- Courses Section -->
                              <div id="courses" class="cv-section">
                                    <div class="section-header">
                              ...
                              <?php if (!empty($socialMedia)): ?>
                                    <div id="connect" class="cv-section">
                                          <div class="section-header">
